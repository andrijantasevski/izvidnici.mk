  ...
  <div className="relative bg-[#455227]">
    ...
    {data.map((item) => (
      <div key={item.whatisLearn} className="py-10">
        <div className="mx-auto w-10/12 rounded-3xl border border-base-100 px-4 py-10 text-white ">
        ...
        <div className="mx-auto grid w-10/12 gap-10 py-10 md:grid-cols-3 md:gap-40">
          <div className="z-40 mx-auto flex w-11/12 flex-col justify-center space-y-10 rounded-3xl border border-base-100 px-4 py-4 text-white ">
            <h2 className="mb-7 text-xl font-semibold ">{item.ForHoItis}</h2>
            <p>{item.forHoText}</p>
          </div>
          ...
          <div className=" relative mx-auto flex w-11/12 flex-col justify-center space-y-10 rounded-3xl border border-base-100 px-4 py-4 text-white">
