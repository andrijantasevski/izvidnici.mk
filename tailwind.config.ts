  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "razvigorci-hero":
          "url('/img/background-images/background-razvigorci-hero.png')",
        ...
        "izvidnicki-centri-hero":
          "url('/img/background-images/izvidnicki-centri-hero.png')",
        "izvidnicki-centri-map-left":
          "url('/img/background-images/Group 435 (1).png')",
        "izvidnicki-centri-map-right":
          "url('/img/background-images/Group 435.png')",
